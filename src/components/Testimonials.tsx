      ...
      <AutoScrollCarousel className="testimonials-grid">
        {testimonials.map((testimonial, index) => (
          ...
          >
            ...
            <div style={{ color: 'var(--gold)', fontSize: '0.8rem', letterSpacing: '3px', marginBottom: '1rem' }}>?????</div>
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ fontSize: '0.88rem', fontWeight: 600, color: 'var(--white)' }}>{testimonial.name}</div>
                <div style={{ fontSize: '0.73rem', color: 'var(--gray)', letterSpacing: '0.04em', marginTop: '2px' }}>{testimonial.role}</div>
