    ...
    <section style={{
      ...
      <div style={{ position: 'relative', maxWidth: '1200px', width: '100%', margin: '0 auto' }}>
        ...
        <p style={{
          ...
          Discover the films, television shows, commercials, and digital productions
          that brought their stories to life at our studio.
        </p>

        {/* CTA row */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap' }}>
          <Link href="/#booking" className="btn-primary">Book a Studio →</Link>
